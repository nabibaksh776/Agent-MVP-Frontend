...
import { LoginCustomer } from "@/redux/Auth/apis";
import { useDispatch, useSelector } from "react-redux";
import CircularProgress from "@mui/material/CircularProgress";
import { AppDispatch } from "@/redux/store";
import { useRouter } from "next/navigation";
import { CreateCookies } from "@/components/Server/Cookies";
...
const SignIn: React.FC = () => {
  ...
  // time to save token in cookies
  const setCookieData = async (token: any) => {
    await CreateCookies(token);
  };

  console.log("current_user---", current_user);
  useEffect(() => {
    if (current_user.data !== null && current_user.data.token) {
      setCookieData(current_user.data.token);
      setTimeout(() => {
